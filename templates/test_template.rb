...
file 'features/step_definitions/webrat_steps.rb', %Q{require File.expand_path(File.join(File.dirname(__FILE__), "..", "support", "paths"))
...
Then /^I should be on (.+)$/ do |page_name|
  assert_equal URI.parse(current_url).path, path_to(page_name)
end}